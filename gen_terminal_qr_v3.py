...
def process_single_file(file_path, error_level='L', strip=False):
    """处理单个文件，生成二维码到独立输出目录。"""
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("用法: python gen_terminal_qr_v4.py <文件或文件夹路径> [选项]")
        print()
        print("选项:")
        ...
        print()
        print("示例:")
        print("  python gen_terminal_qr_v4.py ./my_designs/")
        print("  python gen_terminal_qr_v4.py ./my_designs/ M")
        print("  python gen_terminal_qr_v4.py ./my_designs/ L --strip")
        print("  python gen_terminal_qr_v4.py ./single_file.v")
        print("  python gen_terminal_qr_v4.py ./single_file.v M --strip")
        print()
